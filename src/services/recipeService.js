...
const gDefaultRecipes = [
    { _id: 'r1', title: 'schnitzel', type: 'main', onePot: false, tags: ['chicken', 'shabbat'], kosherStatus: 'meat', difficult: false, addedBy: 'admin', addedDate: Date.now(), quick: true, time: '30 minutes', link: '' },
    { _id: 'r2', title: 'veggie stir-fry', type: 'main', onePot: true, tags: ['vegetarian', 'pasta', 'leftovers'], kosherStatus: 'parve', difficult: false, addedBy: 'admin', addedDate: Date.now(), quick: true, time: '30 minutes', link: '' },
    { _id: 'r3', title: 'moroccan tilapia', type: 'main', onePot: false, tags: ['fish', 'shabbat', 'healthy'], kosherStatus: 'parve', difficult: false, addedBy: 'admin', addedDate: Date.now(), quick: true, time: '30 minutes', link: '' },
    { _id: 'r4', title: 'tuna noodle casserole', type: 'main', onePot: true, tags: ['kid-friendly', 'pasta'], kosherStatus: 'dairy', difficult: false, addedBy: 'admin', addedDate: Date.now(), quick: true, time: '30 minutes', link: '' },
    { _id: 'r5', title: 'veggie skewers', type: 'vegetable side', onePot: false, tags: ['kid-friendly', 'healthy', 'light'], kosherStatus: 'parve', difficult: true, addedBy: 'admin', addedDate: Date.now(), quick: false, time: '45 minutes', link: '' },
...
function query(filterBy) {
    ...
    if (filterBy) {
        var { kosherStatus, quick, type } = filterBy
